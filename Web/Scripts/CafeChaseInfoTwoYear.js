function showTwoInfo() {
    ...
    if (Info[0].kcYear < Info[0].NowYear) {
...
//        document.getElementById("btnComit").style.display = "";
    ...
    for (var i = 0; i < Info.length; i++) {
        ...
        strHtml += '<td><input style="width:95%;" id="kMeasure' + i + '" value="' + Info[i].kMeasure + '"/></td></tr>';
    }
    ...
    if (Info[0].kcYear < Info[0].NowYear) {
        ...
        strHtml += '<tr><td>' + YearE + '目标</td><td style="text-align:right;"><input name="iTd"  onblur="this.value=txtOnblur(this.value)" onfocus="this.value=txtOnfocus(this.value)" style="width:95%;height:25px;text-align:right;" id="kcYear_Target" value="' + txtOnblur(Info[0].kcYear_Target) + '" /></td><td></td><td></td><td style="border-width: 0px;" colspan="9"></td></tr>';
    }
