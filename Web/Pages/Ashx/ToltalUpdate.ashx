<%@ WebHandler Language="C#" Class="ToltalCaculate" %>
...
public class ToltalCaculate : IHttpHandler {
    ...
    /// 获取总支出合计值
    /// </summary>
    public void GetToltalCaculate(HttpContext context)
    {
