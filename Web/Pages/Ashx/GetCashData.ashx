<%@ WebHandler Language="C#" Class="GetCashData" %>
...
public class GetCashData : IHttpHandler
{
    ...
    public void Get_Data01(HttpContext context)
    {
        ...
        string sql = "select DATEPART(YEAR,cYear) year1 from T_Cash  group by DATEPART(YEAR,cYear)";
