<%@ WebHandler Language="C#" Class="GetWagesData" %>
...
public class GetWagesData : IHttpHandler
{
    ...
    public void Get_Data01(HttpContext context)
    {
        ...
        string sql = "select DATEPART(YEAR,cYear) year1 from T_Wages  group by DATEPART(YEAR,cYear)";
