<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BudgetNew.aspx.cs" Inherits="Pages_Index_BudgetNew" %>
...
<head id="Head1" runat="server">
    ...
    <script src="../../Scripts/BudgetInfoOneYear.js" type="text/javascript"></script>
    <script src="../../Scripts/BudgetInfoTwoYear.js" type="text/javascript"></script>
    <script src="../../Scripts/BudgetSaveOneYear.js" type="text/javascript"></script>
    <script src="../../Scripts/BudgetSaveTwoYear.js" type="text/javascript"></script>
...
<%--                <td><button onclick="SaveInfo()" style="width:65px;" type="button"><img alt="" style="float:left; width:15px; height:15px;"  src="../../images/Manager/commit1.png" />提交</button></td>--%>
