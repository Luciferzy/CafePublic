...
//            document.getElementById("2018LaAllYear1").style = 'color:red';
    ...
    function showCafe() {
        ...
        var LaAllYear = Info[i].LaAllYear.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var LastMonthPlan = Info[i].LastMonthPlan.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var Adjust = Info[i].Adjust.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var StageGoal = Info[i].StageGoal.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var Balance1 = Info[i].Balance1.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var Adjusted = Info[i].Adjusted.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var Balance2 = Info[i].Balance2.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
        var OriPlan = Info[i].OriPlan.replace(/\B(?=(\d{3})+(?!\d))/g, ",");
           ...
           //滚动周年
            ...
            '<td id="pasYear' + i + '" style="background-color:#bfbfbf"><input style="background-color:white" class="cafeTb" id="' + Info[i].cYear + 'LaAllYear' + Info[i].TheMonth + '" value="' + LaAllYear+ '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.-]/g,\'\')"';
            if (nowYear > Info[i].cYear) {
                ...
                strHtml += '<td id="plan' + i + '" style="background-color:#bfbfbf"><input style="background-color:white" class="cafeTb" id="' + Info[i].cYear + 'LastMonthPlan' + Info[i].TheMonth + '" value="' + LastMonthPlan + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.-]/g,\'\')"';
            if (nowYear > Info[i].cYear) {
            ...
            //进度调整
            strHtml += '<td id="adjust' + i + '" style="background-color:lightblue"><input readonly="readonly" style="border:none;background-color:lightblue;margin:0" class="cafeTb" id="' + Info[i].cYear + 'Adjust' + Info[i].TheMonth + '" value="' + Adjust + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.-]/g,\'\')"/></td>';
            ...
            if (nowYear > Info[i].cYear) {
                if (Info[i].TheMonth == 1) {
                    ...
                    strHtml += 'value="' + StageGoal + '" readonly="readonly" style="border:none"/></td>';
                }
                ...
                if (Info[i].TheMonth == 1) {
                    ...
                    strHtml += 'value="' + StageGoal + '"/></td>';
                }
            }

            strHtml += '<td id="OriPlan' + i + '"><input readonly="readonly" style="border:none" class="cafeTb" id="' + Info[i].cYear + 'OriPlan' + Info[i].TheMonth + '" value="' + OriPlan + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.]/g,\'\')"/></td>';

            strHtml += '<td id="baA' + i + '" style="background-color:#FFEC23"><input readonly="readonly" style="background-color:#FFEC23;border:none;height:100%" class="cafeTb" id="' + Info[i].cYear + 'Balance1' + Info[i].TheMonth + '" value="' + Balance1 + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.]/g,\'\')"/></td>';
            ...
            strHtml += '</td>' +
             ...
             '<td id="adjusted' + i + '"><input readonly="readonly" style="border:none" class="cafeTb" id="' + Info[i].cYear + 'Adjusted' + Info[i].TheMonth + '" value="' + Adjusted + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.]/g,\'\')"/></td>';

            strHtml += '<td id="baB' + i + '" style="background-color:#FFEC23"><input readonly="readonly" style="background-color:#FFEC23;border:none;height:100%" class="cafeTb" id="' + Info[i].cYear + 'Balance2' + Info[i].TheMonth + '" value="' + Balance2 + '" onchange="FuncAdd(this)" onkeyup="this.value=this.value.replace(/[^0-9.]/g,\'\')"/></td>';
