<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CafeStatisticsAllN.aspx.cs" Inherits="Pages_Index_CafeStatisticsAllN" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        ...
        function GetInfo() {
            Info.length = 0;
            var Str = "?act=getcashstatisticinfoall&UserCode=" + UserCode + "&YearS=" + YearS + "&YearE=" + YearE;
