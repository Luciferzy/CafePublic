<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CafeStatisticsN.aspx.cs" Inherits="Pages_Index_CafeStatisticsN" %>
...
//            document.getElementById("spanDept").innerHTML = DeptName;
        ...
        function GetInfo() {
            Info.length = 0;
            var Str = "?act=getcashstatisticinfo&UserCode=" + UserCode + "&YearS=" + YearS + "&YearE=" + YearE;
