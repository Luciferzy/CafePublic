<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FixedAssets.aspx.cs" Inherits="FixedAssets" %>
...
//   membername = getUrlParam("MemberName");
   ...
   function InitFixedAssets() {
      //alert(a);
       var EquipmentName = "";
        ...
        if (mname == "" || mname == null) {
            ...
            if (Grade == 0) {
                var Str = "?act=initfixedassets&mname=" + mname + "&equipmentname=" + EquipmentName;
    ...
    '<th style="width:80px;text-align:center;">开始折期</th>' +
...
<div class="content-wrapper" id="Div1" style="margin-left:15px">
  ...
  <div style="overflow-x:scroll"><table style="border-collapse:collapse;width:99%;background:white;height:15px" border="1";>
   <tr><td id="welcome"  style="height:20px;text-align:center;font-size:10pt;font-weight:bold;width:200px;">
   
  </td>
   <td  style="width:700px;border-style:none;height:20px">

<table class="choYea" width="600px" height="20px"><td  style="height:24px;width:90px;text-align:center;">资产名称：</td><td ><input type="text" id="EquipmentName" value="" size="20"  /> <input type="button" name="btSure" id="btSure" onclick="search()" value="查询" style="width:50px; background-color:White; border:solid 1px lightgray;margin:2px;"/><input type="button" name="btSure1" id="btSure1" onclick="Add_FixedAssets()" value="新增" style="width:50px; background-color:White; border:solid 1px lightgray;margin:2px;"/></td><td></td></table>
