    ...
    function InitBudget() {
        ...
        if (mname == "" || mname == null) {
            ...
            if (Grade == 0) {
                ...
                var Str = "?act=initbudget&mname=" + membername + "&year=" + nowYear;
                entity.PostStringInfo(Str, this, this.InfoCallBack);
            }
            if (Grade == 1) {
...
//    改变合计、小计项目的底色
    ...
    function HideTd(value) {
        ...
        switch (id) {
            ...
            case "1P":
                ...
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "") - 1) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "1R":
                document.getElementById("1M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "") ) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "2P":
            ...
            case "3P":
                ...
                break;
            case "3R":
                document.getElementById("5M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "4P":
                document.getElementById("6M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "4R":
                document.getElementById("7M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "5P":
                document.getElementById("8M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "5R":
                document.getElementById("9M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "6P":
                document.getElementById("10M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "6R":
                document.getElementById("11M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
            ...
            case "7P":
                ...
                break;
            case "7R":
                document.getElementById("13M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "8P":
                document.getElementById("14M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "8R":
                document.getElementById("15M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "9P":
                document.getElementById("16M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "9R":
                document.getElementById("17M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
            ...
            case "10P":
                ...
                break;
            case "10R":
                document.getElementById("19M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "11P":
                document.getElementById("20M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "11R":
                document.getElementById("21M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
                break;
            case "12P":
                document.getElementById("22M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "R").style = "checked";
                break;
            case "12R":
                document.getElementById("23M").style.display = 'none';
                for (var i = 0; i < 56; i++) {
                    document.getElementById((id.replace(/[^0-9]/ig, "")) + "M" + i).style.display = 'none';
                }
                document.getElementById(id + "P").style = "checked";
    ...
    function DisHide() {
        ...
        var strHtml = '<div style="width:300px;height:300px;background-color:white;float:left"><table style="margin:10px;padding:5px"><tr>' +
        '<td>2017</td>';
        for(var i=1;i<13;i++){
            strHtml += '<td style="padding:3px"><input id="'+i+'P" type="checkbox" name="checkbox"  style="width:17px" onclick="HideTd(this)"/><span>' + i + 'P</span></td>' +
            '<td style="padding:3px"><input id="' + i + 'R" type="checkbox" name="checkbox"  style="width:17px" onclick="HideTd(this)"/><span>' + i + 'R</span></td>';
        }
        strHtml += '</tr><tr></table>'+
        ...
        '<td>2018</td>';
        for(var i=1;i<13;i++){
            strHtml += '<td style="padding:3px"><input type="checkbox" name="checkbox"  style="width:17px" /><span>' + i + 'P</span></td>' +
            '<td style="padding:3px"><input type="checkbox" name="checkbox"  style="width:17px"/><span>' + i + 'R</span></td>';
        }
        strHtml += '</tr><tr></table>'+
        ...
        strHtml += '</tr><tr></table><div style="margin:10px;"><a href="#" onclick="DidDivScreen()" style="padding:10px">收起</a> <a href="#" onclick="HideorNot()" style="padding:10px">确定</a></div></div>';

      

        document.getElementById("divscreen").style.display = '';
        document.getElementById("divscreen").innerHTML = strHtml;
        document.getElementById("radio").checked = true;

    }


    function DidDivScreen() {
    ...
    function SaveBudget() {
        ...
        if (confirm("确定要提交预算表吗？")) {
            var Str = "?act=savebudget&year=" + year + "&mname=" + mname;
            // alert(Str);
